...
const STATUT_BADGE: Record<string, { label: string; color: string }> = {
  citee:      { label: "Citée",             color: "#a3e635" },
  ...
  if (loading) return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ textAlign: "center" }}>
        <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.76rem", color: "#7a7a7a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "8px" }}>
          Interrogation des IAs en cours...
        </p>
        <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.66rem", color: "#4a4a4a", fontWeight: 300 }}>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 60px" }}>
        ...
        <div style={{ padding: "24px", border: "1px solid #2a2a2a", background: "#0f0f0f", marginBottom: "16px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
            ...
            {/* Score perception */}
            <div>
              <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.58rem", letterSpacing: "0.3em", color: "#7a7a7a", textTransform: "uppercase", marginBottom: "14px" }}>Score de visibilité IA</p>
              <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "8px" }}>
                <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "3.5rem", color: "#f0f0f0", lineHeight: 1 }}>{data.score_perception}</span>
              ...
              <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.70rem", color: "#7a7a7a", fontWeight: 300, lineHeight: 1.7 }}>
            ...
            {/* Résumé par LLM */}
            <div>
              <p style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.58rem", letterSpacing: "0.3em", color: "#7a7a7a", textTransform: "uppercase", marginBottom: "14px" }}>Résumé par IA</p>
              {data.llms.map((llm) => {
                const badge = STATUT_BADGE[llm.statut];
                return (
                  <div key={llm.nom} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 14px", background: "#0f0f0f", border: "1px solid #2a2a2a", marginBottom: "6px" }}>
        ...
        <div style={{ padding: "24px", border: "1px solid #2a2a2a", background: "#0f0f0f", marginBottom: "16px" }}>
          ...
          {data.llms.map((llm) => {
            ...
            return (
              <div key={llm.nom} style={{ padding: "20px", background: "#161616", border: "1px solid #2a2a2a", marginBottom: "12px" }}>
                {/* Header */}
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
                  <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.1rem", letterSpacing: "0.1em", color: "#f0f0f0" }}>
                    {llm.nom}
                  </span>
                  <span style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.58rem", letterSpacing: "0.1em", padding: "3px 10px", border: `1px solid ${badge.color}`, color: badge.color, textTransform: "uppercase" }}>
                    {badge.label}
                ...
                {/* Verbatim */}
                <div style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.72rem", color: "#7a7a7a", fontWeight: 300, lineHeight: 1.7, fontStyle: "italic", padding: "12px 16px", background: "#0f0f0f", borderLeft: `2px solid ${borderColor}`, marginBottom: "14px" }}>
                  "{llm.verbatim}"
                </div>
                ...
                <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
                  <div style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                    <span style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.58rem", letterSpacing: "0.15em", color: "#4a4a4a", textTransform: "uppercase" }}>Ton</span>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                    <span style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.58rem", letterSpacing: "0.15em", color: "#4a4a4a", textTransform: "uppercase" }}>Citation directe</span>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                    <span style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.58rem", letterSpacing: "0.15em", color: "#4a4a4a", textTransform: "uppercase" }}>Sources</span>
        ...
        {data.delta.length > 0 && (
          <div style={{ padding: "24px", border: "1px solid #2a2a2a", background: "#0f0f0f", marginBottom: "16px" }}>
            ...
            {data.delta.map((item, i) => (
              <div key={i} style={{ padding: "16px 20px", background: "#161616", border: "1px solid #2a2a2a", borderLeft: "2px solid #60a5fa", marginBottom: "8px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "flex-start", marginTop: "8px" }}>
          <button
            ...
            style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.66rem", letterSpacing: "0.22em", textTransform: "uppercase", padding: "10px 24px", background: "transparent", border: "1px solid #3a3a3a", color: "#7a7a7a", cursor: "pointer", transition: "border-color 0.3s, color 0.3s" }}
